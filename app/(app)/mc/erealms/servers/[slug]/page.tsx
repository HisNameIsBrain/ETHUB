    ...
    <div className="min-h-screen bg-[#020617] text-slate-50">
      <main className="relative mx-auto max-w-3xl space-y-8 px-4 pb-24 pt-20 md:px-8">
        ...
        <section className="space-y-3 rounded-2xl border border-emerald-500/40 bg-gradient-to-br from-emerald-500/15 via-emerald-500/10 to-sky-500/10 p-4 text-sm text-slate-100 md:p-6">
          <p>
            This realm is designed to feel like those early servers that made
            you feel safe and seen, but with the reliability you wished you had
            back then. It plugs into your ETHUB stack so your story, your work,
            and your infrastructure stay in one place.
          </p>
          <Button
            asChild
            size="lg"
          ...
          <p className="text-xs text-emerald-100/85">
            The tooling handles the boring logistics. Your job is to build the
            kind of world a scared 14-year-old could log into and finally exhale.
          </p>
        </section>
      </main>
    </div>
