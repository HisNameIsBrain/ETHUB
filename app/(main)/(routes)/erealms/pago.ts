// app/(marketing)/erealms/page.tsx
"use client";
      ...
      <main className="relative mx-auto flex max-w-6xl flex-col gap-16 px-4 pb-24 pt-20 md:px-8">
        ...
        <section className="space-y-6">
          ...
          <div className="grid gap-4 md:grid-cols-2">
            {timeline.map((item) => (
              <Card
                key={item.title}
                className="border-slate-700/70 bg-black/50 backdrop-blur"
              >
        ...
        <section className="space-y-6">
          <div className="flex flex-col justify-between gap-3 md:flex-row md:items-end">
            ...
            <Button asChild variant="outline" className="rounded-xl text-xs md:text-sm">
            ...
            {serverCards.map((card) => (
              ...
              >
                ...
                <CardContent className="flex flex-1 flex-col justify-between gap-3">
                  ...
                  <Button asChild size="sm" className="mt-2 rounded-xl text-xs">
