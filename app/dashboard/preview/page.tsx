...
>>>>>>> c7b2be9e13fdc8b7867a1e2e2b17f6a4b5ad3dfd
"use client";
...
=======
  const previewUrl =
>>>>>>> c7b2be9e13fdc8b7867a1e2e2b17f6a4b5ad3dfd
    process.env.NEXT_PUBLIC_ETHUB_PREVIEW_URL || "http://localhost:3000";
...
=======
      <header className="mb-2 flex items-center justify-between">
        <div className="flex items-center gap-2">
          <div className="flex h-8 w-8 items-center justify-center rounded-full bg-gradient-to-tr from-sky-500 to-indigo-500 text-white shadow-[0_0_25px_rgba(56,189,248,0.7)]">
            <MonitorPlay className="h-4 w-4" />
          </div>
          <div>
            <div className="text-xs font-semibold tracking-[0.16em] text-slate-200">
              LIVE PREVIEW
            </div>
            <div className="text-[11px] text-slate-500">
              ETHUB app rendered via embedded browser
            </div>
>>>>>>> c7b2be9e13fdc8b7867a1e2e2b17f6a4b5ad3dfd
          </div>
        </div>
...
=======
      ...
      <div className="flex-1 overflow-hidden rounded-xl border border-white/5 bg-slate-950/80">
        <iframe
          key={key}
          src={previewUrl}
>>>>>>> c7b2be9e13fdc8b7867a1e2e2b17f6a4b5ad3dfd
